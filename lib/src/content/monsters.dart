...
void jellies() {
  ...
  breed("green jelly", 1, green, 7)
      .attack("crawl[s] on", 4);
  // TODO: More elements.

  group("j", flags: "few fearless immobile");
  breed("green slime", 2, darkGreen, 7)
      .attack("crawl[s] on", 4)
      .spawn(rate: 4);

  breed("frosty slime", 4, gray, 14)
  ...
  breed("caustic slime", 25, darkYellow, 50)
  ...
  // TODO: Fly?
  breed("ectoplasm", 45, darkGray, 40)
