...
void helms() {
  ...
  item("Leather Cap", 4, 0.5, persimmon)
    ..armor(2, weight: 2)
...
void bodyArmor() {
  ...
  item("Robe", 2, 0.5, cerulean)
    ..armor(4)
    ..destroy(Elements.fire, chance: 15, fuel: 8);
  item("Fur-lined Robe", 6, 0.25, sherwood)
    ..armor(6)
...
void cloaks() {
  ...
  item("Cloak", 3, 0.5, ultramarine)
    ..armor(2, weight: 1)
    ..destroy(Elements.fire, chance: 20, fuel: 5);
  item("Fur Cloak", 5, 0.2, garnet)
    ..armor(3, weight: 1)
...
void shields() {
  ...
  // TODO: Encumbrance.
  item("Small Leather Shield", 3, 0.5, garnet)
    ..armor(3, weight: 2)
    ..destroy(Elements.fire, chance: 7, fuel: 14);
  item("Wooden Targe", 8, 0.5, sandal)
    ..armor(4, weight: 4)
    ..destroy(Elements.fire, chance: 14, fuel: 20);
  item("Large Leather Shield", 17, 0.5, persimmon)
    ..armor(5, weight: 5)
...
void boots() {
  ...
  item("Pair[s] of Sandals", 2, 0.24, persimmon)
    ..armor(1)
    ..destroy(Elements.fire, chance: 20, fuel: 3);
  item("Pair[s] of Shoes", 8, 0.3, garnet)
    ..armor(2)
