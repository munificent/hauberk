...
(function dartProgram() {
  ...
  Q = {MappingAction: function MappingAction() {
    ...
    main: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, depthSelect, i, _null = null, _s4_ = "item",
        _s9_ = "item/food",
        _s6_ = "hit[s]",
        _s8_ = "bash[es]",
        _s7_ = "stab[s]",
      ...
      depthSelect = H.interceptedTypeCast(document.querySelector("#depth"), "$isSelectElement");
      for (i = 1; i <= 100; ++i)
        depthSelect.appendChild(W.OptionElement_OptionElement$_(C.JSInt_methods.toString$0(i), C.JSInt_methods.toString$0(i), _null, i === 1));
    ...
    generate: function() {
      var i, itemType, item, _i, t4, affix, t5, t6,
        _s19_ = "    <tr>\n      <td>",
        _s16_ = "</td>\n      <td>",
        _s20_ = "</td>\n    </tr>\n    ",
        t1 = P.String,
      ...
      for (i = 0; i < 10000; ++i) {
        t2 = $.$get$Items_types();
        t3 = document;
        itemType = t2.tryChoose$1(P.int_parse(H.interceptedTypeCast(t3.querySelector("#depth"), "$isSelectElement").value));
        if (itemType == null)
          continue;
        item = Z.Affixes_createItem(itemType, P.int_parse(H.interceptedTypeCast(t3.querySelector("#depth"), "$isSelectElement").value));
      ...
      C.JSArray_methods.add$1(t2, W._SimpleNodeValidator$(null, H.setRuntimeTypeInfo(["*::style"], [t1]), null));
      J.setInnerHtml$2$validator$x(document.querySelector("table"), t4.charCodeAt(0) == 0 ? t4 : t4, new W.NodeValidatorBuilder(t2));
    },
  ...
  Z = {SpearMastery: function SpearMastery(t0) {
    ...
    Affixes_createItem: function(itemType, droppedDepth) {
      ...
      t1 = $.$get$rng();
      affixes = t1.float$1(100) < chance + 0 ? 1 : 0;
  ...
  (function installTearOffs() {
    ...
    _instance(R._ItemBuilder.prototype, "get$depth", 0, 1, null, ["call$2$to", "call$1"], ["depth$2$to", "depth$1"], 8, 0);
    _instance(R._AffixBuilder.prototype, "get$depth", 0, 1, null, ["call$2$to", "call$1"], ["depth$2$to", "depth$1"], 8, 0);
    _static_1(Q, "skills_Skills_find$closure", "Skills_find", 32);
    var _;
    _instance_2_u(_ = L.Affix.prototype, "get$resist", "resist$2", 41);
    _instance_2_u(_, "get$setStatBonus", "setStatBonus$2", 42);
  })();
  (function inheritance() {
    ...
    _inherit(W.SpeechSynthesisEvent, W.Event);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, args: [,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: -1, args: [P.int], named: {to: P.int}}, {func: 1, ret: G.WindAction, args: [P.int]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, args: [P.String]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, args: [, P.String]}, {func: 1, ret: G.BurnActorAction, args: [P.int]}, {func: 1, ret: G.BurnFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.FreezeActorAction, args: [P.int]}, {func: 1, ret: G.FreezeFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.PoisonAction, args: [P.int]}, {func: 1, ret: G.PoisonFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.BlindAction, args: [P.int]}, {func: 1, ret: E.DazzleAction, args: [P.int]}, {func: 1, ret: G.LightFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: X.EatAction}, {func: 1, ret: T.DetectAction}, {func: 1, ret: Q.PerceiveAction}, {func: 1, ret: E.ResistAction}, {func: 1, ret: Q.MappingAction}, {func: 1, ret: M.Skill, args: [P.String]}, {func: 1, ret: S.TeleportAction}, {func: 1, ret: O.HealAction}, {func: 1, ret: G.RingSelfAction}, {func: 1, ret: G.RingFromAction, args: [L.Vec]}, {func: 1, ret: N.FlowSelfAction}, {func: 1, ret: N.FlowFromAction, args: [L.Vec]}, {func: 1, ret: F.IlluminateSelfAction}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: -1, args: [G.Element0, P.int]}, {func: 1, ret: -1, args: [D.Stat, P.int]}, {func: 1, ret: P.int}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: E.HasteAction}], interceptorsByTag: null, leafTags: null};
  (function constants() {
