  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JSArray: {
      ...
      static: {
        ...
        }, "call$2", "_interceptors_JSArray__compareAny$closure", 8, 0, 82]
      }
    },
    JSUnmodifiableArray: {
      "^": "JSArray;$ti"
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 16, 0, 10],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          ...
          if (!(t3 == t1.hostname && t2.port == t1.port && t2.protocol == t1.protocol))
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 16, 0, 10]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    NodeValidatorBuilder_allowsAttribute_closure: {
      "^": "Closure:13;element,attributeName,value",
      call$1: function(v) {
    ...
    }, "call$1$2", "call$2", "math__max$closure", 8, 0, 85],
    _JSRandom: {
      "^": "Object;",
    ...
    }, "call$1", "skills_Skills_find$closure", 4, 0, 86],
    Skills_closure: {
      "^": "Closure:41;",
    ...
    Blob__make: function(size, smoothing, input) {
      ...
      if (input != null)
        for (t1 = cells.bounds, t2 = X.RectIterator$(t1.inflate$1(-1)), t3 = H.getTypeArgumentByIndex(cells, 0), t4 = cells._elements, t1 = t1.size.x, t5 = input._elements, t6 = input.bounds.size.x, t7 = t5.length; t2.moveNext$0();) {
          ...
          t10 = H.assertSubtypeOfRuntimeType($.$get$rng().float$1(1) > value, t3);
          if (typeof t1 !== "number")
            return H.iae(t1);
        ...
        for (t2 = X.RectIterator$(t1.inflate$1(-1)), t3 = H.getTypeArgumentByIndex(cells, 0), t4 = cells._elements, t1 = t1.size.x; t2.moveNext$0();) {
          ...
          t7 = H.assertSubtypeOfRuntimeType($.$get$rng().float$1(1) > t7 / maxLength, t3);
          if (typeof t1 !== "number")
            return H.iae(t1);
          if (typeof t5 !== "number")
            return H.iae(t5);
            ...
            while (true)
              switch ($async$goto) {
                ...
                case 3:
                  ...
                  cave = M.Blob_make(C.JSNumber_methods.toInt$0(Math.pow(t1.float$2(minSize, maxSize), 2)));
                  ...
                  case 0:
                    ...
                    for (t1 = cells1.bounds, t2 = X.RectIterator$(t1), t3 = H.getTypeArgumentByIndex(cells1, 0), t4 = cells1._elements, t1 = t1.size.x; t2.moveNext$0();) {
                      ...
                      if (!$async$self._architect._canCarve$2($async$self, pos))
                        continue;
                      t7 = H.assertSubtypeOfRuntimeType($.$get$rng().float$1(1) < $async$self._cavern$_density$2($async$self._region, pos), t3);
                      if (typeof t1 !== "number") {
                        H.iae(t1);
                        // goto return
                        $async$goto = 1;
    ...
    Decorator__spawnMonster_spawn: {
      "^": "Closure:53;_box_0,$this,isCorpse,density",
          ...
          switch (t3[t8]) {
            ...
            case C.RoomTile_junctionW_Direction_m1_0:
              if (this._regionContains$1(here))
                C.JSArray_methods.add$1(junctions, new Z.Junction(here, t3[t8].get$direction(), 0));
              break;
          }
        }
        t1 = $.$get$rng();
            ...
            while (true)
              switch ($async$goto) {
                ...
                case 3:
                  ...
                  t2._floorLightDirty = false;
                  t2._actorLightDirty = false;
                  t2._visibilityDirty = false;
                  // implicit return
                  return P._IterationMarker_endOfIteration();
                case 1:
                  // rethrow
    ...
    Hero: {
      ...
      }, "call$1", "get$refreshSkill", 4, 0, 63],
      static: {
    ...
    Inventory: {
      ...
      }, "tryAdd$1", "call$2$wasUnequipped", "call$1", "get$tryAdd", 4, 3, 71],
      get$iterator: function(_) {
        var t1 = this._items;
    ...
    Flow__processNext_processNeighbor: {
      "^": "Closure:73;$this,start,parentCost",
    ...
    Lighting__process_checkNeighbor: {
      "^": "Closure:74;$this,pos,parentLight,tiles,attenuate",
    ...
    Stage_placeDrops_closure: {
      "^": "Closure:17;$this,items,flow,pos",
      call$1: function(item) {
    ...
    Rect: {
      ...
      get$center: function() {
        return new L.Vec(C.JSInt_methods._tdivFast$1(this.get$left() + this.get$right(), 2), C.JSInt_methods._tdivFast$1(this.get$top(this) + this.get$bottom(), 2));
      },
      toString$0: function(_) {
      ...
      trace$0: function() {
        ...
        if (t3 && t1.y > 1) {
          ...
          return new X.Rect(new L.Vec(this.get$left(), this.get$top(this)), new L.Vec(t2, 1));
        else {
          t1 = t1.y;
          if (t1 >= 1 && t2 === 1)
            return new X.Rect(new L.Vec(this.get$left(), this.get$top(this)), new L.Vec(1, t1));
        }
    ...
    "^": "",
    main: function() {
      var t1, depthSelect, t2, i;
      t1 = document;
      depthSelect = H.interceptedTypeCast(C.HtmlDocument_methods.querySelector$1(t1, "#depth"), "$isSelectElement");
      for (t2 = depthSelect && C.SelectElement_methods, i = 1; i <= 100; ++i)
        t2.append$1(depthSelect, W.OptionElement_OptionElement$_(C.JSInt_methods.toString$0(i), C.JSInt_methods.toString$0(i), null, i === 1));
      depthSelect.toString;
      t2 = W.Event;
      W._EventStreamSubscription$(depthSelect, "change", H.functionTypeCheck(new U.main_closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t1 = J.get$onClick$x(C.HtmlDocument_methods.querySelector$1(t1, "table"));
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new U.main_closure0(), {func: 1, ret: -1, args: [t2]}), false, t2);
      U.generate();
      U.generateTable();
    },
    generate: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, addItem, _i, actor;
      t1 = $.$get$content();
      t2 = $.$get$save();
      t3 = document;
      t4 = P.int_parse(H.interceptedTypeCast(C.HtmlDocument_methods.querySelector$1(t3, "#depth"), "$isSelectElement").value, null, null);
      t5 = P.ListQueue$(null, O.Message);
      t6 = V.Action;
      t7 = P.ListQueue$(null, t6);
      t6 = H.setRuntimeTypeInfo([], [t6]);
      t8 = H.setRuntimeTypeInfo([], [D.Event0]);
      t9 = [L.Vec];
      t10 = H.setRuntimeTypeInfo([], t9);
      t4 = new D.Game(t1, t2, new O.Log(t5), t7, t6, t8, new Y.Energy(0), t10, t4);
      t1 = L.Stage$(80, 60, t4);
      t4._stage = t1;
      C.JSArray_methods.addAll$1(t10, t1.tiles.bounds.inflate$1(-1));
      t1 = $.$get$rng();
      t1.toString;
      C.JSArray_methods.shuffle$1(H.assertSubtype(t10, "$isList", t9, "$asList"), t1._random);
      $.game = t4;
      for (t1 = t4.generate$0(), t1 = new P._SyncStarIterator(t1._outerHelper(), [H.getTypeArgumentByIndex(t1, 0)]); t1.moveNext$0();)
        H.printString(H.S(t1.get$current()));
      addItem = new U.generate_addItem();
      for (t1 = $.game._stage._actors, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (actor instanceof B.Monster) {
          t4 = $.$get$monsters();
          t5 = actor._breed;
          t4.add$1(0, O.Log__categorize(t5._breed$_name, false, true));
          t5.drop.spawnDrop$2(P.int_parse(H.interceptedTypeCast(C.HtmlDocument_methods.querySelector$1(t3, "#depth"), "$isSelectElement").value, null, null), addItem);
        }
      }
      $.game._stage.get$allItems().forEach$1(0, addItem);
    ...
    generateTable: function() {
      ...
      text._contents = "<thead>\n    <tr>\n      <td>Monsters</td>\n      <td>Items</td>\n      <td>Affixes</td>\n    </tr>\n  </thead><tr>";
      t1 = new U.generateTable_renderColumn(text);
      t2 = $.$get$monsters();
      t3 = t2._counts;
      t4 = P.int;
      t1.call$2(t2, t3.get$values(t3).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t4), t4));
      t3 = $.$get$items();
      t2 = t3._counts;
      t1.call$2(t3, t2.get$values(t2).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t4), t4));
      t2 = $.$get$affixes();
      t3 = $.$get$items()._counts;
      t1.call$2(t2, t3.get$values(t3).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t4), t4));
      text._contents += "</tr>";
      t4 = C.HtmlDocument_methods.querySelector$1(document, "table");
      t3 = text._contents;
      J.setInnerHtml$2$validator$x(t4, t3.charCodeAt(0) == 0 ? t3 : t3, $.$get$validator());
    },
    main_closure: {
      "^": "Closure:78;",
      call$1: function(_) {
        ...
        t2 = P.int;
        t3 = [t1];
        $.monsters = new T.Histogram(P.LinkedHashMap_LinkedHashMap$_empty(t1, t2), t3);
    ...
    generate_addItem: {
      ...
      call$1: function(item) {
        var t1;
        H.interceptedTypeCheck(item, "$isItem");
        $.$get$items().add$1(0, O.Log__categorize(item.type.quantifiableName, false, true));
        t1 = item.prefix;
        if (t1 != null)
          $.$get$affixes().add$1(0, t1.name + " _");
        t1 = item.suffix;
        if (t1 != null)
          $.$get$affixes().add$1(0, "_ " + t1.name);
      }
    },
    generateTable_renderColumn: {
      "^": "Closure:80;text",
      call$2: function(histogram, max) {
        var t1, t2, t3, _i, $name, count, t4, width, t5, percent, chance;
        H.assertSubtype(histogram, "$isHistogram", [P.String], "$asHistogram");
        t1 = this.text;
        t1._contents += '<td width="25%">';
        for (t2 = histogram.descending$0(), t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, H.throwConcurrentModificationError)(t2), ++_i) {
          $name = t2[_i];
          count = histogram.count$1($name);
          if (typeof count !== "number")
            return H.iae(count);
          t4 = 100 * count;
          if (typeof max !== "number")
            return H.iae(max);
          width = C.JSInt_methods.$tdiv(t4, max);
          t5 = histogram.get$total(histogram);
          if (typeof t5 !== "number")
            return H.iae(t5);
          percent = C.JSString_methods.padLeft$2(C.JSDouble_methods.toStringAsFixed$1(t4 / t5, 2), 5, "0");
          chance = C.JSString_methods.padLeft$1(C.JSDouble_methods.toStringAsFixed$1(count / $.generated, 1), 6);
          t1._contents += '<span style="font-family: monospace;">' + percent + "% " + chance + " </span>";
          t5 = t1._contents += '<div class="bar" style="width: ' + width + 'px;"></div> ' + H.S($name);
          t1._contents = t5 + "<br>";
        }
        t1._contents += "</td>";
      }
    ...
    Histogram: {
      ...
      get$total: function(_) {
        var t1 = this._counts;
        return t1.get$values(t1).fold$1$2(0, 0, new T.Histogram_total_closure(), P.int);
      },
      ...
      static: {
        Histogram$: function($T) {
          return new T.Histogram(P.LinkedHashMap_LinkedHashMap$_empty($T, P.int), [$T]);
        }
      }
    },
    Histogram_total_closure: {
      "^": "Closure:81;",
      call$2: function(a, b) {
        H.intTypeCheck(a);
        H.intTypeCheck(b);
...
;
  ...
  }, "rng", "monsters", "$get$monsters", function() {
    return T.Histogram$(P.String);
  }, "monsters", "items", "$get$items", function() {
    return T.Histogram$(P.String);
  }, "items", "affixes", "$get$affixes", function() {
    return T.Histogram$(P.String);
  }, "affixes", "validator", "$get$validator", function() {
    var t1 = W.NodeValidatorBuilder$common();
    t1.add$1(0, W._SimpleNodeValidator$(null, H.setRuntimeTypeInfo(["*::style"], [P.String]), null, null));
    return t1;
  }, "validator", "save", "$get$save", function() {
    return $.$get$content().createHero$1("hero");
  }, "save", "content", "$get$content", function() {
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: S.TeleportAction}, {func: 1, ret: V.Action, args: [L.Vec]}, {func: 1, args: [,]}, {func: 1, ret: E.HasteAction}, {func: 1, ret: P.bool, args: [L.Vec]}, {func: 1, ret: P.Null, args: [P.int]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.Null, args: [L.Vec]}, {func: 1, ret: P.int}, {func: 1, ret: P.Null, args: [R.Item]}, {func: 1, ret: E.ResistAction}, {func: 1, ret: G.BurnFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.FreezeActorAction, args: [P.int]}, {func: 1, ret: G.FreezeFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.PoisonAction, args: [P.int]}, {func: 1, ret: G.PoisonFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.BlindAction, args: [P.int]}, {func: 1, ret: E.DazzleAction, args: [P.int]}, {func: 1, ret: G.LightFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: X.EatAction}, {func: 1, ret: T.DetectAction}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: Q.MappingAction}, {func: 1, ret: O.HealAction}, {func: 1, ret: G.RingSelfAction}, {func: 1, ret: G.RingFromAction, args: [L.Vec]}, {func: 1, ret: N.FlowSelfAction}, {func: 1, ret: N.FlowFromAction, args: [L.Vec]}, {func: 1, ret: F.IlluminateSelfAction}, {func: 1, ret: P.Null, args: [L.Drop, P.double]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: P.Null, args: [P.String, P.double]}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: P.Null, named: {canFill: P.bool, create: {func: 1, ret: X.Architecture}, decor: P.String, decorDensity: P.double, end: P.int, frequency: P.double, itemDensity: P.double, monsterDensity: P.double, monsters: P.String, start: P.int}}, {func: 1, ret: Z.Keep}, {func: 1, ret: Q.Dungeon}, {func: 1, ret: D.Catacomb}, {func: 1, ret: Q.Cavern}, {func: 1, ret: F.Lake}, {func: 1, ret: G.River}, {func: 1, ret: P.Null, args: [P.String], named: {end: P.int, start: P.int}}, {func: 1, ret: A.Pit}, {func: 1, ret: [P.List, L.Vec]}, {func: 1, ret: P.Null, args: [X.Architecture, [P.List, L.Vec]]}, {func: 1, ret: P.Null, args: [B.Breed, L.Vec]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.double, args: [P.int,,]}, {func: 1, ret: P.bool, args: [Z.Direction]}, {func: 1, args: [P.String]}, {func: 1, ret: Q.OpenBarrelAction, args: [L.Vec]}, {func: 1, ret: -1, args: [E.Condition]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.Null, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: -1, args: [M.Skill]}, {func: 1, ret: P.Null, args: [P.double]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: P.double, args: [P.int, P.int]}, {func: 1, ret: -1, args: [G.Element0, P.int]}, {func: 1, ret: -1, args: [D.Stat, P.int]}, {func: 1, ret: P.int, args: [P.int, R.Item]}, {func: 1, ret: P.bool, args: [R.Item]}, {func: 1, ret: O.AddItemResult, args: [R.Item], named: {wasUnequipped: P.bool}}, {func: 1, ret: R.Item, args: [R.Item]}, {func: 1, ret: P.Null, args: [Z.Direction, P.bool]}, {func: 1, ret: P.Null, args: [L.Vec, P.int]}, {func: 1, ret: Q.Tile}, {func: 1, ret: P.Null, args: [P.String, P.int]}, {func: 1, ret: O.Inventory}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: P.Null, args: [[T.Histogram, P.String], P.int]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, ret: G.WindAction, args: [P.int]}, {func: 1, ret: G.BurnActorAction, args: [P.int]}, {func: 1, bounds: [P.num], ret: 0, args: [0, 0]}, {func: 1, ret: M.Skill, args: [P.String]}, {func: 1, ret: Q.OpenChestAction, args: [L.Vec]}];
...
//# sourceMappingURL=generation.dart.js.map
