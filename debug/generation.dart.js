...
(function dartProgram() {
  ...
  T = {GameContent: function GameContent() {
    ...
    Histogram_total_closure: function Histogram_total_closure() {
    },
  ...
  U = {HowlMove: function HowlMove(t0, t1) {
    ...
    main: function() {
      var i, t2,
        t1 = document,
        depthSelect = H.interceptedTypeCast(t1.querySelector("#depth"), "$isSelectElement");
      for (i = 1; i <= 100; ++i)
        depthSelect.appendChild(W.OptionElement_OptionElement$_(C.JSInt_methods.toString$0(i), C.JSInt_methods.toString$0(i), null, i === 1));
      ...
      t1 = J.get$onClick$x(t1.querySelector("table"));
    ...
    generate: function() {
      var t8, t9, t10, addItem, _i, actor,
        t1 = $.$get$content(),
        t2 = $.$get$save(),
        t3 = document,
        t4 = P.int_parse(H.interceptedTypeCast(t3.querySelector("#depth"), "$isSelectElement").value),
        t5 = H.setRuntimeTypeInfo([], [O.Message]),
        t6 = V.Action,
        t7 = P.ListQueue$(t6);
      ...
      t4 = new D.Game(t1, t2, new O.Log(t5), t7, t6, t8, new Y.Energy(), t10, t4);
      t1 = L.Stage$(80, 60, t4);
      t4._stage = t1;
      ...
      for (t1 = $.game._stage._actors, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (actor instanceof B.Monster) {
          ...
          t5.drop.dropItem$2(P.int_parse(H.interceptedTypeCast(t3.querySelector("#depth"), "$isSelectElement").value), addItem);
        }
      }
    ...
    generateTable: function() {
      ...
      t1.call$2(t2, t3.get$values(t3).fold$1$2(0, 0, H.instantiate1(P.math__max$closure(), t4), t4));
      text._contents += "</tr>";
      t4 = document.querySelector("table");
      t3 = text._contents;
    ...
    generate_addItem: function generate_addItem() {
    },
    generateTable_renderColumn: function generateTable_renderColumn(t0) {
      this.text = t0;
    }
  },
  L = {
  ...
  U.generateTable_renderColumn.prototype = {
  ...
  T.Histogram_total_closure.prototype = {
    call$2: function(a, b) {
      H.intTypeCheck(a);
      H.intTypeCheck(b);
      if (typeof a !== "number")
  ...
  (function installTearOffs() {
    ...
    _instance_1_i(J.JSArray.prototype, "get$add", "add$1", 30);
    ...
    _instance(R._ItemBuilder.prototype, "get$depth", 0, 1, null, ["call$2$to", "call$1"], ["depth$2$to", "depth$1"], 12, 0);
    _instance(R._AffixBuilder.prototype, "get$depth", 0, 1, null, ["call$2$to", "call$1"], ["depth$2$to", "depth$1"], 12, 0);
    _static_1(Q, "skills_Skills_find$closure", "Skills_find", 90);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: V.Action, args: [L.Vec]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: P.bool, args: [L.Vec]}, {func: 1, args: [,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: -1, args: [P.int], named: {to: P.int}}, {func: 1, ret: P.Null, args: [P.String], named: {end: P.int, start: P.int}}, {func: 1, ret: P.Null, args: [L.Vec]}, {func: 1, ret: P.Null, args: [P.int]}, {func: 1, ret: P.int}, {func: 1, ret: P.bool, args: [R.Item]}, {func: 1, ret: P.Null, args: [R.Item]}, {func: 1, ret: T.DetectAction}, {func: 1, ret: G.BurnFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.FreezeActorAction, args: [P.int]}, {func: 1, ret: G.FreezeFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.PoisonAction, args: [P.int]}, {func: 1, ret: G.PoisonFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.BlindAction, args: [P.int]}, {func: 1, ret: E.DazzleAction, args: [P.int]}, {func: 1, ret: G.LightFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: X.EatAction}, {func: 1, ret: -1, args: [P.Object]}, {func: 1, ret: Q.PerceiveAction}, {func: 1, ret: E.ResistAction}, {func: 1, ret: Q.MappingAction}, {func: 1, ret: E.HasteAction}, {func: 1, ret: S.TeleportAction}, {func: 1, ret: O.HealAction}, {func: 1, ret: G.RingSelfAction}, {func: 1, ret: G.RingFromAction, args: [L.Vec]}, {func: 1, ret: N.FlowSelfAction}, {func: 1, ret: N.FlowFromAction, args: [L.Vec]}, {func: 1, ret: F.IlluminateSelfAction}, {func: 1, ret: P.Null, args: [L.Drop, P.double]}, {func: 1, ret: P.Null, args: [P.String, P.double]}, {func: 1, ret: P.Null, args: [P.String, [P.List, P.Object]]}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: P.Null, args: [P.String], named: {canFill: P.bool, create: {func: 1, ret: X.Architecture}, decor: P.String, decorDensity: P.double, end: P.int, endFrequency: P.double, itemDensity: P.double, monsterDensity: P.double, monsters: P.String, start: P.int, startFrequency: P.double}}, {func: 1, ret: Q.Dungeon}, {func: 1, ret: D.Catacomb}, {func: 1, ret: Q.Cavern}, {func: 1, ret: F.Lake}, {func: 1, ret: G.River}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: A.Pit}, {func: 1, ret: Z.Keep}, {func: 1, ret: [P.List, L.Vec]}, {func: 1, ret: P.Null, args: [X.Architecture, [P.List, L.Vec]]}, {func: 1, ret: P.Null, args: [B.Breed, L.Vec]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: P.double, args: [P.int,,]}, {func: 1, args: [W.Event]}, {func: 1, ret: Q.OpenChestAction, args: [L.Vec]}, {func: 1, ret: Q.OpenBarrelAction, args: [L.Vec]}, {func: 1, ret: Q.TileType, args: [Z._TileBuilder, P.int]}, {func: 1, ret: -1, args: [E.Condition]}, {func: 1, args: [P.String]}, {func: 1, ret: -1, args: [M.Skill]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.Null, args: [P.double]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.double, args: [P.int, P.int]}, {func: 1, ret: P.bool, args: [M.Skill]}, {func: 1, ret: -1, args: [G.Element0, P.int]}, {func: 1, ret: -1, args: [D.Stat, P.int]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: P.int, args: [P.int, R.Item]}, {func: 1, ret: O.AddItemResult, args: [R.Item], named: {wasUnequipped: P.bool}}, {func: 1, ret: P.Null, args: [Z.Direction, P.bool]}, {func: 1, ret: P.Null, args: [L.Vec, P.int]}, {func: 1, ret: Q.Tile}, {func: 1, ret: P.Null, args: [P.String, P.int]}, {func: 1, ret: O.Inventory}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: P.Null, args: [[T.Histogram, P.String], P.int]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, ret: G.WindAction, args: [P.int]}, {func: 1, ret: G.BurnActorAction, args: [P.int]}, {func: 1, bounds: [P.num], ret: 0, args: [0, 0]}, {func: 1, ret: M.Skill, args: [P.String]}, {func: 1, ret: P.bool, args: [Z.Direction]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "monsters", "$get$monsters", function() {
      return T.Histogram$(P.String);
    });
    _lazy($, "items", "$get$items", function() {
      return T.Histogram$(P.String);
    });
    _lazy($, "affixes", "$get$affixes", function() {
      return T.Histogram$(P.String);
    });
