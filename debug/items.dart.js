...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "ApplicationCacheErrorEvent|ErrorEvent|Event|InputEvent|MediaError|Navigator|NavigatorConcurrentHardware|PositionError|SQLError|SensorErrorEvent|SpeechRecognitionError"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    MapBase__id: [function(x) {
      return x;
    }, "call$1", "collection_MapBase__id$closure", 4, 0, 1],
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 16, 0, 3],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          ...
          if (!(t3 == t1.hostname && t2.port == t1.port && t2.protocol == t1.protocol))
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 16, 0, 3]
      }
    },
    ImmutableListMixin: {
      "^": "Object;$ti",
    ...
    NodeValidatorBuilder_allowsAttribute_closure: {
      "^": "Closure:4;element,attributeName,value",
      call$1: function(v) {
    ...
    Elements_closure4: {
      ...
      call$4: function(pos, hit, distance, _) {
        ...
        t1._element$_emanation = K.lerpDouble(hit.get$range().$sub(0, distance), 0, hit.get$range(), min, max).toInt$0(0);
        return t1;
      }
    }
  }], ["", "package:hauberk/src/content/item/affixes.dart",, Z, {}], ["", "package:hauberk/src/content/item/builder.dart",, R, {
    "^": "",
    ...
    _CategoryBuilder: {
      "^": "_BaseBuilder;0_glyph,0_equipSlot,0_weaponType,0_tag,0_verb,_isTreasure,_skills,_destroyChance,0_maxStack,0_tossElement,0_tossDamage,0_tossRange,0_tossUse,0_emanation,0_fuel,0_breakage",
      tag$1: function(tagPath) {
    ...
    _ItemBuilder: {
      "^": "_BaseBuilder;0_color,0_frequency,0_price,0_use,0_attack,0_weight,0_heft,0_armor,0_name,0_depth,_skills,_destroyChance,0_maxStack,0_tossElement,0_tossDamage,0_tossRange,0_tossUse,0_emanation,0_fuel,0_breakage",
    ...
    potions: function() {
      ...
      t1.tag$1("magic/potion/resistance");
      t1.toss$3$breakage$damage$range(100, 1, 6);
      t1._destroyChance.$indexSet(0, t2, 20);
      t1._fuel = null;
      ...
      t13.tag$1("magic/potion/bottled");
    ...
    scrolls: function() {
      ...
      t1.tag$1("magic/scroll/teleportation");
      ...
      t3.tag$1("magic/scroll/detection");
    ...
    }, "call$1", "skills_Skills_find$closure", 4, 0, 24],
    Skills_closure: {
      "^": "Closure:31;",
    ...
    Vec: {
      "^": "VecBase;x,y",
      get$hashCode: function(_) {
        return (this.x ^ this.y) & 0x1FFFFFFF;
      },
      $eq: function(_, other) {
        if (other == null)
          return false;
    ...
    "^": "",
    main: function() {
      var text, t1, t2, t3, t4, t5, t6, t7, items, _i, item, glyph;
      text = new P.StringBuffer("");
      t1 = $.$get$Items_types();
      t1.defineTags$1("item");
      t2 = R.category(199, 10, null);
      t2.tag$1("item");
      t2.toss$4$breakage$damage$element$range(10, 3, $.$get$Elements_earth(), 7);
      ...
      t3 = $.$get$Elements_fire();
      t2._destroyChance.$indexSet(0, t3, 40);
      t2._fuel = 1;
      ...
      t2._destroyChance.$indexSet(0, t3, 20);
      t2._fuel = 3;
      ...
      t2.tag$1("item/food");
      t2._destroyChance.$indexSet(0, t3, 15);
      t2._fuel = 2;
      ...
      C.JSArray_methods.addAll$1(t2._skills, new H.MappedListIterable(t5, H.functionTypeCheck(Q.skills_Skills_find$closure(), {func: 1, ret: t6, args: [t7]}), [t7, t6]));
      t6 = R.category(225, null, "hit[s]");
      t6.tag$1("equipment/weapon/club");
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Club Mastery"));
      ...
      t6.toss$1$damage(4);
      t6._destroyChance.$indexSet(0, t3, 5);
      t6._fuel = 10;
      t6 = R.item("Club", 6, C.Color_64_31_36, 0.5, 40);
      t6.weapon$2$heft(12, 11);
      t6.toss$1$damage(5);
      t6._destroyChance.$indexSet(0, t3, 2);
      t6._fuel = 10;
      t6 = R.category(237, null, "hit[s]");
      t6.tag$1("equipment/weapon/staff");
      ...
      t6.tag$1("equipment/weapon/hammer");
      ...
      t6.tag$1("equipment/weapon/mace");
      ...
      t6.tag$1("equipment/weapon/whip");
      t6.toss$2$breakage$range(25, 4);
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Whip Mastery"));
      ...
      t6.tag$1("equipment/weapon/dagger");
      ...
      t6.tag$1("equipment/weapon/sword");
      t6.toss$2$breakage$range(20, 5);
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Swordfighting"));
      ...
      t6.tag$1("equipment/weapon/spear");
      t6.toss$1$range(9);
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Spear Mastery"));
      ...
      t6.toss$1$damage(20);
      t6 = R.category(186, null, "stab[s]");
      t6.tag$1("equipment/weapon/polearm");
      t6.toss$1$range(4);
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Spear Mastery"));
      ...
      t6.tag$1("equipment/weapon/axe");
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Axe Mastery"));
      ...
      t6.tag$1("equipment/weapon/bow");
      t6.toss$2$breakage$range(50, 5);
      C.JSArray_methods.add$1(t6._skills, Q.Skills_find("Archery"));
      ...
      t6._armor = 6;
      t6._weight = 8;
      R.category(244, null, null).tag$1("equipment/armor/body/robe");
      ...
      t6._destroyChance.$indexSet(0, t3, 12);
      t6._fuel = 8;
      R.category(246, null, null).tag$1("equipment/armor/body");
      ...
      t6._fuel = 4;
      R.category(242, null, null).tag$1("equipment/armor/body");
      ...
      t6._armor = 36;
      t6._weight = 7;
      R.category(198, null, null).tag$1("equipment/armor/cloak");
      ...
      t6.tag$1("equipment/armor/gloves");
      ...
      t6.tag$1("equipment/armor/shield");
      ...
      t6._armor = 7;
      t6._weight = 9;
      R.category(236, null, null).tag$1("equipment/armor/boots");
      ...
      t6._destroyChance.$indexSet(0, t3, 14);
      t6._fuel = 3;
      R.category(196, null, null).tag$1("equipment/armor/boots");
      ...
      t1 = H.getTypeArgumentByIndex(items, 0);
      t6 = H.functionTypeCheck(new V.main_closure(), {func: 1, ret: P.int, args: [t1, t1]});
      H.Sort_sort(items, t6, t1);
      text._contents = '    <thead>\n    <tr>\n      <td colspan="2">Item</td>\n      <td>Depth</td>\n      <td>Stack</td>\n      <td>Price</td>\n      <td>Equip.</td>\n      <td>Weapon</td>\n      <td>Attack</td>\n      <td>Armor</td>\n      <td>Weight</td>\n      <td>Heft</td>\n      <td>Use</td>\n      <td>Toss</td>\n    </tr>\n    </thead>\n    <tbody>\n    ';
      for (t1 = items.length, t2 = [P.int], _i = 0, t3 = '    <thead>\n    <tr>\n      <td colspan="2">Item</td>\n      <td>Depth</td>\n      <td>Stack</td>\n      <td>Price</td>\n      <td>Equip.</td>\n      <td>Weapon</td>\n      <td>Attack</td>\n      <td>Armor</td>\n      <td>Weight</td>\n      <td>Heft</td>\n      <td>Use</td>\n      <td>Toss</td>\n    </tr>\n    </thead>\n    <tbody>\n    '; _i < items.length; items.length === t1 || (0, H.throwConcurrentModificationError)(items), ++_i) {
        item = items[_i];
        glyph = item.get$appearance();
        t3 = glyph.fore;
        text._contents += '        <tr>\n          <td>\n<pre><span style="color: ' + ("rgb(" + t3.r + ", " + t3.g + ", " + t3.b + ")") + '">' + P.String_String$fromCharCodes(H.setRuntimeTypeInfo([glyph.char], t2), 0, null) + "</span></pre>\n          </td>\n          <td>" + H.S(O.Log__categorize(item.quantifiableName, false, true)) + "</td>\n        ";
        t3 = new V.main_writeCell(text);
        t3.call$2(item.depth, null);
        t3.call$2(item.maxStack, "none");
        t3.call$2(item.price, "none");
        t3.call$2(item.equipSlot, null);
        t3.call$2(item.weaponType, null);
        t3.call$2(item.attack, null);
        t3.call$2(item.armor, 0);
        t3.call$2(item.heft, 0);
        t3.call$2(item.weight, 0);
        t3 = item.use;
        if (t3 == null)
          t3 = text._contents += "<td>&mdash;</td>";
        else {
          t3 = t3.call$0();
          t3.toString;
          t3 = text._contents += "<td>" + new H.TypeImpl(H.getRti(t3)).toString$0(0) + "</td>";
        }
        t5 = item.toss;
        if (t5 == null) {
          t3 += "<td>&mdash;</td>";
          ...
          t3 = text._contents += "<td>" + t5.attack.toString$0(0);
          t6 = t5.use;
          if (t6 != null) {
            t3 = t6.call$1(C.Vec_0_0);
            t3.toString;
            t3 = text._contents += " " + new H.TypeImpl(H.getRti(t3)).toString$0(0) + " ";
          }
          t5 = t5.breakage;
          if (t5 !== 0)
            t3 = text._contents += " " + t5 + "%";
          t3 += "</td>";
          text._contents = t3;
        }
        t3 += "</tr>";
      ...
      text._contents = t3 + "</tbody>";
      t1 = H.setRuntimeTypeInfo([], [W.NodeValidator]);
      C.JSArray_methods.add$1(t1, W._Html5NodeValidator$(null));
      C.JSArray_methods.add$1(t1, W._TemplatingNodeValidator$());
      C.JSArray_methods.add$1(t1, W._SimpleNodeValidator$(null, H.setRuntimeTypeInfo(["*::style"], t4), null, null));
      t2 = C.HtmlDocument_methods.querySelector$1(document, "table");
      t3 = text._contents;
      J.setInnerHtml$2$validator$x(t2, t3.charCodeAt(0) == 0 ? t3 : t3, new W.NodeValidatorBuilder(t1));
    },
    main_closure: {
      "^": "Closure:34;",
      call$2: function(a, b) {
    ...
    main_writeCell: {
      "^": "Closure:35;text",
      call$2: function(value, defaultValue) {
        var t1 = this.text;
        if (value == null ? defaultValue == null : value === defaultValue)
          t1._contents += "<td>&mdash;</td>";
        else
          t1._contents += "<td>" + H.S(value) + "</td>";
      }
    }
  }, 1]];
...
;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: S.TeleportAction}, {func: 1, args: [,]}, {func: 1, ret: E.HasteAction}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: E.FreezeActorAction, args: [P.int]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: G.WindAction, args: [P.int]}, {func: 1, ret: G.BurnActorAction, args: [P.int]}, {func: 1, ret: G.BurnFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: G.FreezeFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.PoisonAction, args: [P.int]}, {func: 1, ret: G.PoisonFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.BlindAction, args: [P.int]}, {func: 1, ret: E.DazzleAction, args: [P.int]}, {func: 1, ret: G.LightFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: X.EatAction}, {func: 1, ret: T.DetectAction}, {func: 1, ret: E.ResistAction}, {func: 1, ret: Q.MappingAction}, {func: 1, ret: O.HealAction}, {func: 1, ret: M.Skill, args: [P.String]}, {func: 1, ret: G.RingFromAction, args: [L.Vec]}, {func: 1, ret: N.FlowSelfAction}, {func: 1, ret: N.FlowFromAction, args: [L.Vec]}, {func: 1, ret: F.IlluminateSelfAction}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: P.Null, args: [P.int]}, {func: 1, ret: P.Null, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: P.int, args: [L.ItemType, L.ItemType]}, {func: 1, ret: P.Null, args: [P.Object, P.Object]}, {func: 1, args: [P.String]}, {func: 1, ret: G.RingSelfAction}];
