  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JSArray: {
      ...
      static: {
        ...
        }, "call$2", "_interceptors_JSArray__compareAny$closure", 8, 0, 51]
      }
    },
    JSUnmodifiableArray: {
      "^": "JSArray;$ti"
    ...
    HtmlElement: {
      "^": "Element;",
      "%": "HTMLAudioElement|HTMLBRElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadingElement|HTMLHtmlElement|HTMLImageElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMarqueeElement|HTMLMediaElement|HTMLMenuElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLOptGroupElement|HTMLOptionElement|HTMLParagraphElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTimeElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLVideoElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
    ...
    FixedSizeListIterator: {
      "^": "Object;_array,_length,_position,0_html$_current,$ti",
    ...
    finishItem: function() {
      ...
      if (t14 == null)
        t14 = 0;
      t15 = t1._builder0$_emanation;
      if (t15 == null)
        t15 = t2._builder0$_emanation;
      t1 = t1._fuel;
      if (t1 == null)
        t1 = t2._fuel;
      t2 = t2._isTreasure;
      ...
      t20 = $._item._builder0$_frequency;
      t21 = $._category._builder0$_tag;
      t18.toString;
    ...
    _CategoryBuilder: {
      "^": "_BaseBuilder;0_glyph,0_equipSlot,0_weaponType,0_builder0$_tag,0_builder0$_verb,_isTreasure,_skills,_destroyChance,0_maxStack,0_tossElement,0_tossDamage,0_tossRange,0_tossUse,0_builder0$_emanation,0_fuel,0_breakage",
      tag$1: function(_, tagPath) {
        ...
        this._builder0$_tag = H.stringTypeCheck(C.JSArray_methods.get$last(tags));
        for (_i = 0; _i < 9; ++_i) {
    ...
    _ItemBuilder: {
      "^": "_BaseBuilder;0_color,0_builder0$_frequency,0_price,0_use,0_attack,0_weight,0_heft,0_armor,0_builder0$_name,0_builder0$_depth,_skills,_destroyChance,0_maxStack,0_tossElement,0_tossDamage,0_tossRange,0_tossUse,0_builder0$_emanation,0_fuel,0_breakage",
      ...
      weapon$3$element$heft: function(damage, element, heft) {
        this._attack = U.Attack$(null, $._category._builder0$_verb, damage, null, element);
        this._heft = heft;
      },
      ...
      lightSource$2$level$range: function(level, range) {
        this._builder0$_emanation = level;
    ...
    _ItemBuilder_lightSource_closure: {
      "^": "Closure:34;range,level",
      call$0: function() {
        return new F.IlluminateSelfAction(this.range, this.level + 1);
      }
    },
    _AffixBuilder: {
      "^": "Object;_builder0$_name,_isPrefix,_builder0$_depth,_builder0$_frequency,0_heftScale,0_weightBonus,0_strikeBonus,0_damageScale,0_damageBonus,0_brand,0_armor,0_priceBonus,0_priceScale,_resists,_statBonuses",
    ...
    finishBreed: function() {
      ...
      if (t19 == null)
        t19 = 0;
      t20 = t3._builder$_speed;
      if (t20 == null)
        t20 = 0;
      t21 = t10._builder$_speed;
      if (t21 == null)
        t21 = 0;
      ...
      t36 = $._builder._frequency;
      if (t36 == null)
        t36 = $.$get$_family()._frequency;
    ...
    _FamilyBuilder: {
      "^": "_BaseBuilder0;0_character,_frequency,0_tracking,_motility,0_location,0_builder$_speed,0_meander,0_dodge,_defenses,_groups,0_flags,0_countMin,0_countMax,0_stain,0_emanationLevel,0_vision,0_hearing",
      static: {
    ...
    _BreedBuilder: {
      "^": "_BaseBuilder0;_builder$_name,_builder$_depth,_appearance,_health,_attacks,_moves,_builder$_drops,_minions,0_pronoun,0_description,_frequency,0_tracking,_motility,0_location,0_builder$_speed,0_meander,0_dodge,_defenses,_groups,0_flags,0_countMin,0_countMax,0_stain,0_emanationLevel,0_vision,0_hearing",
      ...
      drop$4$count$depthOffset$percent: function($name, count, depthOffset, percent) {
        var drop = new X._PercentDrop(percent, X.parseDrop($name, this._builder$_depth + depthOffset));
        if (count > 1)
    ...
    Monsters_initialize: function() {
      ...
      t4 = t4._bitMask;
      t10 = t10._bitMask;
      t15._motility = new Q.Motility(t4 | t10);
      ...
      t4._vision = 10;
      t4._hearing = 5;
      t4._motility = new Q.Motility(t4._motility._bitMask | t10);
      ...
      t13._vision = 0;
      t13._hearing = 0;
      t13._motility = new Q.Motility(t13._motility._bitMask | t10);
      ...
      t13._motility = new Q.Motility(t13._motility._bitMask | t6);
      t13.count$2(3, 6);
      ...
      t1._motility = new Q.Motility(t1._motility._bitMask | t10);
      ...
      t1._motility = new Q.Motility(t10._bitMask | t12._bitMask);
    ...
    }, "call$1", "skills_Skills_find$closure", 4, 0, 36],
    Skills_closure: {
      "^": "Closure:37;",
    ...
    _TileBuilder: {
      ...
      open$0: function(_) {
        var t1, t2;
        t1 = $.$get$Motility_flyAndWalk();
        t2 = C.JSArray_methods.get$first(this.glyphs);
        return new Q.TileType(this.name, false, this._emanation, t2, t1, this._onClose, this._onOpen);
      },
      static: {
        _TileBuilder__TileBuilder: function($name, char, fore, $back) {
          var charCode = C.JSString_methods._codeUnitAt$1(char, 0);
          return new Z._TileBuilder($name, H.setRuntimeTypeInfo([L.Glyph$fromCharCode(charCode, fore, C.Color_19_17_28)], [L.Glyph]), false, 0);
        }
      }
    }
    ...
    Affix: {
      ...
      }, "call$2", "get$setStatBonus", 8, 0, 41],
      toString$0: function(_) {
        return this.name;
      }
    }
    ...
    Breed: {
      "^": "Object;pronoun,appearance,depth<,attacks,moves,maxHealth,tracking,vision,hearing,meander,speed,drop,location,motility,flags,dodge,emanationLevel,defenses,countMin<,countMax<,minions,_name,stain,groups,description",
      get$name: function(_) {
    ...
    "^": "",
    shownData: function() {
      return H.interceptedTypeCast(C.HtmlDocument_methods.querySelector$1(document, "select"), "$isSelectElement").value;
    },
    main: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, i, select;
      t1 = $.$get$Items_types();
      t1.defineTags$1("item");
      t2 = R.category(199, 10, null);
      t2.tag$1(0, "item");
      t3 = $.$get$Elements_earth();
      t2.toss$4$breakage$damage$element$range(10, 3, t3, 7);
      R.item("Rock", 1, C.Color_142_82_55, 1, null);
      t2 = R.category(252, 4, null);
      t2.tag$1(0, "item");
      t2.toss$3$breakage$damage$range(30, 2, 5);
      R.item("Skull", 1, C.Color_132_126_135, 1, null);
      t2 = R.category(162, null, null);
      ...
      t2 = R.category(233, 4, null);
      t2._destroyChance.$indexSet(0, t4, 20);
      t2._fuel = 3;
      R.item("Fur Pelt", 1, C.Color_142_82_55, 1, null);
      R.item("Fox Pelt", 2, C.Color_122_44_24, 1, null);
      t2 = R.category(161, null, null);
      t2.tag$1(0, "item/food");
      t2._destroyChance.$indexSet(0, t4, 20);
      t2._fuel = 3;
      t2 = R.item("Stale Biscuit", 1, C.Color_189_144_108, 1, null);
      t2._maxStack = 6;
      t2.food$1(100);
      t2 = R.item("Loa[f|ves] of Bread", 3, C.Color_142_82_55, 1, 4);
      t2._maxStack = 6;
      t2.food$1(200);
      t2 = R.category(188, null, null);
      t2.tag$1(0, "item/food");
      t2._destroyChance.$indexSet(0, t4, 15);
      t2._fuel = 2;
      t2 = R.item("Chunk[s] of Meat", 6, C.Color_64_31_36, 1, 10);
      t2._maxStack = 4;
      t2.food$1(400);
      t2 = R.item("Piece[s] of Jerky", 10, C.Color_142_82_55, 1, 20);
      t2._maxStack = 12;
      t2.food$1(600);
      t2 = R.category(172, null, "hit[s]");
      t2.tag$1(0, "item/light");
      t2.toss$1$breakage(70);
      t2 = R.item("Tallow Candle", 1, C.Color_189_144_108, 1, 6);
      t2._maxStack = 10;
      t2.toss$3$damage$element$range(2, t4, 8);
      t2.lightSource$2$level$range(2, 8);
      t2._destroyChance.$indexSet(0, t4, 40);
      t2._fuel = 20;
      t2 = R.item("Wax Candle", 4, C.Color_226_223_240, 1, 8);
      t2._maxStack = 10;
      t2.toss$3$damage$element$range(3, t4, 8);
      t2.lightSource$2$level$range(3, 10);
      t2._destroyChance.$indexSet(0, t4, 40);
      t2._fuel = 25;
      t2 = R.item("Oil Lamp", 4, C.Color_64_31_36, 1, 18);
      t2._maxStack = 4;
      t2.toss$3$damage$element$range(10, t4, 8);
      t2.lightSource$2$level$range(4, 13);
      t2._destroyChance.$indexSet(0, t4, 50);
      t2._fuel = 40;
      t2 = R.item("Torch[es]", 8, C.Color_142_82_55, 1, 16);
      t2._maxStack = 4;
      t2.toss$3$damage$element$range(6, t4, 10);
      t2.lightSource$2$level$range(5, 18);
      t2._destroyChance.$indexSet(0, t4, 60);
      t2._fuel = 60;
      t2 = R.item("Lantern", 15, C.Color_222_156_33, 0.3, 78);
      t2.toss$3$damage$element$range(5, t4, 5);
      t2.lightSource$2$level$range(6, 24);
      G.potions();
      G.scrolls();
      t2 = R.category(189, 3, null);
      t2.tag$1(0, "magic/book/sorcery");
      t2.toss$3$breakage$damage$range(25, 1, 3);
      t2._destroyChance.$indexSet(0, t4, 5);
      t2._fuel = 10;
      t2 = R.item('Spellbook "Elemental Primer"', 1, C.Color_84_0_39, 0.05, 100);
      t5 = [P.String];
      ...
      C.JSArray_methods.addAll$1(t2._skills, new H.MappedListIterable(t6, H.functionTypeCheck(Q.skills_Skills_find$closure(), {func: 1, ret: t5, args: [t7]}), [t7, t5]));
      ...
      t5.weapon$2$heft(10, 9);
      t5.toss$1$damage(9);
      t5._destroyChance.$indexSet(0, t4, 7);
      t5._fuel = 12;
      ...
      t5.toss$1$damage(2);
      t5._destroyChance.$indexSet(0, t4, 15);
      t5._fuel = 10;
      ...
      t5.toss$1$damage(4);
      t5._destroyChance.$indexSet(0, t4, 4);
      t5._fuel = 14;
      ...
      t5._armor = 2;
      t5._weight = 2;
      t5._destroyChance.$indexSet(0, t4, 12);
      t5._fuel = 2;
      ...
      t5._armor = 15;
      t5._weight = 3;
      t5._destroyChance.$indexSet(0, t4, 8);
      t5._fuel = 4;
      t5 = R.item("Studded Armor", 17, C.Color_63_64_114, 0.5, 400);
      t5._armor = 22;
      t5._weight = 4;
      t5._destroyChance.$indexSet(0, t4, 6);
      t5._fuel = 4;
      ...
      t5._armor = 2;
      t5._weight = 1;
      t5._destroyChance.$indexSet(0, t4, 20);
      t5._fuel = 5;
      t5 = R.item("Fur Cloak", 5, C.Color_64_31_36, 0.2, 140);
      t5._armor = 3;
      t5._weight = 1;
      t5._destroyChance.$indexSet(0, t4, 16);
      t5._fuel = 5;
      ...
      t5._armor = 4;
      t5._weight = 4;
      t5._destroyChance.$indexSet(0, t4, 14);
      t5._fuel = 20;
      ...
      t5._armor = 4;
      t2 = t5._statBonuses;
      t2.$indexSet(0, C.Stat_Strength, 1);
      t2.$indexSet(0, C.Stat_Fortitude, 1);
      t5.resist$1(t6);
      R.finishAffix();
      $._affixTag = "gloves";
      t5 = R.affix("Dwarven _", 50, 1);
      ...
      t5._priceScale = 1.4;
      t5.resist$2(t2, 2);
      t2 = R.affix("_ of Protection from Earth", 17, 0.25);
      t2._priceBonus = 500;
      t2._priceScale = 1.4;
      t2.resist$2(t3, 2);
      ...
      t10._damageBonus = null;
      t10.brand$2$resist(t4, 2);
      t4 = R.affix("Electric _", 50, 0.2);
      t4._priceBonus = 300;
      t4._priceScale = 1.5;
      t4._damageScale = 1.4;
      t4._damageBonus = null;
      t4.brand$1(t11);
      t4 = R.affix("Shocking _", 70, 0.2);
      t4._priceBonus = 400;
      t4._priceScale = 2;
      t4._damageScale = 1.8;
      t4._damageBonus = null;
      t4.brand$2$resist(t11, 2);
      ...
      for (t1 = t1.get$all(), t1 = new H.MappedIterator(J.get$iterator$ax(t1._iterable), t1._f, [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]); t1.moveNext$0();) {
        t2 = t1._current;
        t3 = $.$get$_colors();
        t4 = O.Log__categorize(t2.quantifiableName, false, true);
        t2 = t2.appearance.fore;
        t3.$indexSet(0, t4, "rgb(" + t2.r + ", " + t2.g + ", " + t2.b + ")");
      }
      for (t1 = $.$get$Monsters_breeds().get$all(), t1 = new H.MappedIterator(J.get$iterator$ax(t1._iterable), t1._f, [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]); t1.moveNext$0();) {
        t2 = t1._current;
        t3 = $.$get$_colors();
        t4 = O.Log__categorize(t2._name, false, true);
        t2 = t2.appearance.fore;
        t3.$indexSet(0, t4, "rgb(" + t2.r + ", " + t2.g + ", " + t2.b + ")");
      }
      for (i = -100; i <= 100; ++i)
        $.$get$_colors().$indexSet(0, C.JSInt_methods.toString$0(i), "hsl(" + C.JSInt_methods.$mod((i + 100) * 10, 360) + ", 70%, 40%)");
      t1 = $.$get$_svg();
      t1.toString;
      t2 = W.MouseEvent;
      W._EventStreamSubscription$(t1, "click", H.functionTypeCheck(new U.main_closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
      select = H.interceptedTypeCast(C.HtmlDocument_methods.querySelector$1(document, "select"), "$isSelectElement");
      select.toString;
      t2 = W.Event;
      W._EventStreamSubscription$(select, "change", H.functionTypeCheck(new U.main_closure0(), {func: 1, ret: -1, args: [t2]}), false, t2);
      U._generateMore();
    },
    _generateMore: function() {
      switch (H.interceptedTypeCast(C.HtmlDocument_methods.querySelector$1(document, "select"), "$isSelectElement").value) {
        case "breeds":
          U._moreBreeds();
          break;
        case "item-types":
        ...
        case "affixes":
          ...
          break;
        case "monster-depths":
          U._moreMonsterDepths();
          break;
        case "floor-drops":
          U._moreFloorDrops();
          break;
        default:
          throw H.wrapException("Unknown select value '" + H.S(U.shownData()) + "'.");
      }
    },
    _moreBreeds: function() {
      var depth, t1, t2, histogram, i, breed, _i;
    ...
    _moreItems: function() {
      var depth, t1, t2, histogram, i, itemType;
      for (depth = 1; depth <= 100; ++depth) {
        t1 = $.$get$_itemCounts();
        t2 = depth - 1;
        if (t2 >= t1.length)
        ...
        for (i = 0; i < 1000; ++i) {
          ...
          if (itemType == null)
            continue;
          histogram.add$1(0, O.Log__categorize(itemType.quantifiableName, false, true));
        }
      }
      U._drawItems();
    },
    _moreAffixes: function() {
      var depth, t1, t2, histogram, i, itemType, item, t3;
      for (depth = 1; depth <= 100; ++depth) {
        t1 = $.$get$_affixCounts();
        t2 = depth - 1;
        if (t2 >= t1.length)
        ...
        for (i = 0; i < 1000; ++i) {
          t1 = $.$get$Items_types();
          itemType = t1.tryChoose$2$tag(depth, "equipment");
          if (itemType == null)
            continue;
          if (!t1.hasTag$2(O.Log__categorize(itemType.quantifiableName, false, true), "equipment"))
            continue;
          item = Z.Affixes_createItem(itemType, depth);
          t1 = item.prefix;
          t2 = t1 == null;
          if (!t2)
    ...
    _moreMonsterDepths: function() {
      var depth, t1, t2, histogram, i, breed;
      for (depth = 1; depth <= 100; ++depth) {
        t1 = $.$get$_monsterDepthCounts();
        t2 = depth - 1;
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        histogram = t1[t2];
      ...
      U._drawMonsterDepths();
    },
    _moreFloorDrops: function() {
      var depth, t1, t2, histogram, i;
      for (depth = 1; depth <= 100; ++depth) {
        t1 = $.$get$_floorDropCounts();
        t2 = depth - 1;
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        histogram = t1[t2];
        for (i = 0; i < 1000; ++i)
          $.$get$_floorDrops().tryChoose$1(depth).drop.spawnDrop$2(depth, new U._moreFloorDrops_closure(histogram));
      }
      U._drawFloorDrops();
    },
    _drawBreeds: function() {
      var t1, t2, t3;
      if ($._breedNames == null) {
        t1 = $.$get$Monsters_breeds().get$all();
        t2 = P.String;
        t3 = H.getRuntimeTypeArgument(t1, "Iterable", 0);
        t2 = H.MappedIterable_MappedIterable(t1, H.functionTypeCheck(new U._drawBreeds_closure(), {func: 1, ret: t2, args: [t3]}), t3, t2);
        t2 = P.List_List$from(t2, true, H.getRuntimeTypeArgument(t2, "Iterable", 0));
        $._breedNames = t2;
        C.JSArray_methods.sort$1(t2, new U._drawBreeds_closure0());
      }
      U._redraw($.$get$_breedCounts(), $._breedNames, new U._drawBreeds_closure1());
    },
    _drawItems: function() {
      U._initializeItemNames();
      U._redraw($.$get$_itemCounts(), $._itemNames, new U._drawItems_closure());
    },
    _drawAffixes: function() {
      var t1, t2, t3, t4, i;
      t1 = $._affixNames;
      if (t1 == null) {
        t1 = P.String;
        t2 = H.setRuntimeTypeInfo(["(none)"], [t1]);
        $._affixNames = t2;
        t3 = $.$get$Affixes_prefixes().get$all();
        t4 = H.getRuntimeTypeArgument(t3, "Iterable", 0);
        C.JSArray_methods.addAll$1(t2, H.MappedIterable_MappedIterable(t3, H.functionTypeCheck(new U._drawAffixes_closure(), {func: 1, ret: t1, args: [t4]}), t4, t1));
        t4 = $._affixNames;
        t3 = $.$get$Affixes_suffixes().get$all();
        t2 = H.getRuntimeTypeArgument(t3, "Iterable", 0);
        (t4 && C.JSArray_methods).addAll$1(t4, H.MappedIterable_MappedIterable(t3, H.functionTypeCheck(new U._drawAffixes_closure0(), {func: 1, ret: t1, args: [t2]}), t2, t1));
        t1 = $._affixNames;
        (t1 && C.JSArray_methods).sort$0(t1);
        for (i = 0; t1 = $._affixNames, i < t1.length; ++i)
          $.$get$_colors().$indexSet(0, t1[i], "hsl(" + C.JSInt_methods.$mod(i * 17, 360) + ", 50%, 50%)");
      }
      U._redraw($.$get$_affixCounts(), t1, new U._drawAffixes_closure1());
    },
    _drawMonsterDepths: function() {
      var labels, i;
      labels = H.setRuntimeTypeInfo([], [P.String]);
      for (i = -100; i <= 100; ++i)
        C.JSArray_methods.add$1(labels, "" + i);
      U._redraw($.$get$_monsterDepthCounts(), labels, new U._drawMonsterDepths_closure());
    },
    _drawFloorDrops: function() {
      U._initializeItemNames();
      U._redraw($.$get$_floorDropCounts(), $._itemNames, new U._drawFloorDrops_closure());
    },
    _initializeItemNames: function() {
      var t1, t2, t3;
      if ($._itemNames == null) {
        t1 = $.$get$Items_types().get$all();
        t2 = P.String;
        t3 = H.getRuntimeTypeArgument(t1, "Iterable", 0);
        t2 = H.MappedIterable_MappedIterable(t1, H.functionTypeCheck(new U._initializeItemNames_closure(), {func: 1, ret: t2, args: [t3]}), t3, t2);
        t2 = P.List_List$from(t2, true, H.getRuntimeTypeArgument(t2, "Iterable", 0));
        $._itemNames = t2;
        C.JSArray_methods.sort$1(t2, new U._initializeItemNames_closure0());
      }
    },
    _redraw: function(histograms, labels, describe) {
      var buffer, depth, histogram, t1, total, _i, t2, y, x, right, label, count, fraction, percent, t3;
      H.assertSubtype(histograms, "$isList", [[T.Histogram, P.String]], "$asList");
      H.assertSubtype(labels, "$isList", [P.String], "$asList");
      H.functionTypeCheck(describe, {func: 1, ret: P.String, args: [P.String]});
      buffer = new P.StringBuffer("");
      for (depth = 0; depth < 100;) {
        if (depth >= histograms.length)
          return H.ioore(histograms, depth);
        histogram = histograms[depth];
        for (t1 = labels.length, total = 0, _i = 0; t2 = labels.length, _i < t2; labels.length === t1 || (0, H.throwConcurrentModificationError)(labels), ++_i) {
          t2 = histogram.count$1(labels[_i]);
          if (typeof t2 !== "number")
            return H.iae(t2);
          total += t2;
        }
        y = depth * 6;
        for (++depth, x = 600, right = 600, _i = 0; _i < labels.length; labels.length === t2 || (0, H.throwConcurrentModificationError)(labels), ++_i) {
          label = labels[_i];
          ...
          x -= fraction * 600;
          t1 = buffer._contents += '<rect fill="' + H.S($.$get$_colors().$index(0, label)) + '" x="' + H.S(x) + '" y="' + y + '" width="' + H.S(right - x) + '" height="6">';
          buffer._contents = t1 + ("<title>depth " + depth + ": " + H.S(describe.call$1(label)) + " " + percent + "% (" + count + ")</title></rect>");
          right = x;
        }
      }
      t1 = $.$get$_svg();
      ...
      t3.append$1(t1, t3.createFragment$3$treeSanitizer$validator(t1, t2.charCodeAt(0) == 0 ? t2 : t2, null, null));
    },
    closure3: {
      "^": "Closure:3;",
      call$1: function(_) {
    ...
    _moreFloorDrops_closure: {
      "^": "Closure:45;histogram",
    ...
    _drawAffixes_closure: {
      "^": "Closure:13;",
      call$1: function(affix) {
        return H.interceptedTypeCheck(affix, "$isAffix").name + " _";
      }
    },
    _drawAffixes_closure0: {
      "^": "Closure:13;",
      call$1: function(affix) {
        return "_ " + H.interceptedTypeCheck(affix, "$isAffix").name;
      }
    },
    _drawAffixes_closure1: {
      "^": "Closure:2;",
      call$1: function(label) {
        return label;
      }
    },
    _drawMonsterDepths_closure: {
      "^": "Closure:2;",
      call$1: function(label) {
        var relative = P.int_parse(label, null, null);
        if (relative === 0)
          return "same";
...
;
  ...
  (function(lazies) {
  ...
  }, "Items_types", "collapseNewlines", "$get$collapseNewlines", function() {
  ...
  }, "Monsters_breeds", "Skills_all", "$get$Skills_all", function() {
    ...
    return map;
  }, "Skills__byName", "Tiles_brownJellyStain", "$get$Tiles_brownJellyStain", function() {
  ...
  }, "BreedRef__unresolved", "Motility_door", "$get$Motility_door", function() {
    ...
    t1._random = t2;
    return t1;
  }, "rng", "_svg", "$get$_svg", function() {
    return H.interceptedTypeCast(W.querySelector("svg"), "$isSvgElement");
  }, "_svg", "_breedCounts", "$get$_breedCounts", function() {
    return P.List_List$generate(100, new U.closure3(), true, [T.Histogram, P.String]);
  }, "_breedCounts", "_itemCounts", "$get$_itemCounts", function() {
    return P.List_List$generate(100, new U.closure2(), true, [T.Histogram, P.String]);
  }, "_itemCounts", "_affixCounts", "$get$_affixCounts", function() {
    return P.List_List$generate(100, new U.closure1(), true, [T.Histogram, P.String]);
  }, "_affixCounts", "_monsterDepthCounts", "$get$_monsterDepthCounts", function() {
    return P.List_List$generate(100, new U.closure0(), true, [T.Histogram, P.String]);
  }, "_monsterDepthCounts", "_floorDropCounts", "$get$_floorDropCounts", function() {
    return P.List_List$generate(100, new U.closure(), true, [T.Histogram, P.String]);
  }, "_floorDropCounts", "_colors", "$get$_colors", function() {
    var t1 = P.String;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [T.Histogram, P.String], args: [P.int]}, {func: 1, ret: S.TeleportAction}, {func: 1, args: [,]}, {func: 1, ret: E.HasteAction}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.int, args: [P.String, P.String]}, {func: 1, ret: P.String, args: [L.Affix]}, {func: 1, ret: E.FreezeActorAction, args: [P.int]}, {func: 1, ret: G.WindAction, args: [P.int]}, {func: 1, ret: G.BurnActorAction, args: [P.int]}, {func: 1, ret: G.BurnFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: G.FreezeFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.PoisonAction, args: [P.int]}, {func: 1, ret: G.PoisonFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.BlindAction, args: [P.int]}, {func: 1, ret: E.DazzleAction, args: [P.int]}, {func: 1, ret: G.LightFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: X.EatAction}, {func: 1, ret: T.DetectAction}, {func: 1, ret: E.ResistAction}, {func: 1, ret: Q.MappingAction}, {func: 1, ret: O.HealAction}, {func: 1, ret: G.RingSelfAction}, {func: 1, ret: G.RingFromAction, args: [L.Vec]}, {func: 1, ret: N.FlowSelfAction}, {func: 1, ret: N.FlowFromAction, args: [L.Vec]}, {func: 1, ret: F.IlluminateSelfAction}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: M.Skill, args: [P.String]}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: P.Null, args: [P.int]}, {func: 1, ret: P.Null, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: -1, args: [G.Element0, P.int]}, {func: 1, ret: -1, args: [D.Stat, P.int]}, {func: 1, args: [W.Event]}, {func: 1, ret: -1, args: [W.MouseEvent]}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: P.Null, args: [R.Item]}, {func: 1, ret: P.String, args: [B.Breed]}, {func: 1, args: [P.String]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.String, args: [L.ItemType]}, {func: 1, ret: P.int}, {func: 1, ret: P.int, args: [,,]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: P.Null, args: [,,]}];
