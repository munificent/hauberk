  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JSArray: {
      ...
      static: {
        ...
        }, "call$2", "_interceptors_JSArray__compareAny$closure", 8, 0, 48]
      }
    },
    JSUnmodifiableArray: {
      "^": "JSArray;$ti"
    ...
    String_String$fromCharCodes: function(charCodes, start, end) {
      var t1, len;
      t1 = P.int;
      charCodes = H.assertSubtype(H.assertSubtype(charCodes, "$isIterable", [t1], "$asIterable"), "$isJSArray", [t1], "$asJSArray");
    ...
    FreezeActorAction: {
      "^": "_FreezeActorAction_ConditionAction_DestroyActionMixin;_damage,0_actor,0_pos,0_game,0_consumesEnergy"
    },
    PoisonAction: {
      "^": "ConditionAction;_damage,0_actor,0_pos,0_game,0_consumesEnergy"
    },
    BlindAction: {
      "^": "ConditionAction;_damage,0_actor,0_pos,0_game,0_consumesEnergy"
    },
    ...
    BurnFloorAction: {
      "^": "_BurnFloorAction_Action_DestroyActionMixin;_element$_pos,_element$_damage,_element$_fuel,0_actor,0_pos,0_game,0_consumesEnergy"
    },
    FreezeFloorAction: {
      "^": "_FreezeFloorAction_Action_DestroyActionMixin;_element$_pos,0_actor,0_pos,0_game,0_consumesEnergy"
    },
    PoisonFloorAction: {
      "^": "_PoisonFloorAction_Action_DestroyActionMixin;_element$_pos,_element$_damage,0_actor,0_pos,0_game,0_consumesEnergy"
    },
    WindAction: {
    ...
    _BreedBuilder: {
      "^": "_BaseBuilder0;_builder$_name,_depth,_appearance,_health,_attacks,_moves,_builder$_drops,_minions,0_pronoun,0_description,_frequency,0_tracking,_motility,0_location,0_builder$_speed,0_meander,0_dodge,_defenses,_groups,0_flags,0_countMin,0_countMax,0_stain,0_emanationLevel,0_vision,0_hearing",
      ...
      drop$4$count$depthOffset$percent: function($name, count, depthOffset, percent) {
        var drop = new X._PercentDrop(percent, X.parseDrop($name, this._depth + depthOffset));
        if (count > 1)
    ...
    }, "call$1", "skills_Skills_find$closure", 4, 0, 33],
    Skills_closure: {
      "^": "Closure:38;",
    ...
    ResourceSet: {
      ...
      tryChoose$3$includeParents$tag: function(depth, includeParents, tag) {
        ...
        label = goalTag.name;
        return this._runQuery$3(label, depth, new Y.ResourceSet_tryChoose_closure(t1, this, goalTag));
      },
    ...
    "^": "",
    main: function() {
      var t1, t2, t3, t4, t5, t6, breeds, _i, breed, glyph, count, t7, t8, t9, tags;
      $.$get$Items_types().defineTags$1("item");
      t1 = R.category(199, 10, null);
      t1.tag$1(0, "item");
      t1.toss$4$breakage$damage$element$range(10, 3, $.$get$Elements_earth(), 7);
      ...
      t2 = $.$get$Elements_fire();
      t1._destroyChance.$indexSet(0, t2, 40);
      t1._fuel = 1;
      ...
      t4.weapon$2$heft(10, 9);
      t4.toss$1$damage(9);
      t4._destroyChance.$indexSet(0, t2, 7);
      t4._fuel = 12;
      ...
      t4.toss$1$damage(2);
      t4._destroyChance.$indexSet(0, t2, 15);
      t4._fuel = 10;
      ...
      t4.toss$1$damage(4);
      t4._destroyChance.$indexSet(0, t2, 4);
      t4._fuel = 14;
      ...
      t4._armor = 2;
      t4._weight = 2;
      t4._destroyChance.$indexSet(0, t2, 12);
      t4._fuel = 2;
      ...
      t4._armor = 15;
      t4._weight = 3;
      t4._destroyChance.$indexSet(0, t2, 8);
      t4._fuel = 4;
      t4 = R.item("Studded Armor", 17, C.Color_63_64_114, 0.5, 400);
      t4._armor = 22;
      t4._weight = 4;
      t4._destroyChance.$indexSet(0, t2, 6);
      t4._fuel = 4;
      ...
      t4._armor = 2;
      t4._weight = 1;
      t4._destroyChance.$indexSet(0, t2, 20);
      t4._fuel = 5;
      t4 = R.item("Fur Cloak", 5, C.Color_64_31_36, 0.2, 140);
      t4._armor = 3;
      t4._weight = 1;
      t4._destroyChance.$indexSet(0, t2, 16);
      t4._fuel = 5;
      ...
      t4._armor = 4;
      t4._weight = 4;
      t4._destroyChance.$indexSet(0, t2, 14);
      t4._fuel = 20;
      ...
      t4 = $.$get$Monsters_breeds();
      t2 = t4.get$all();
      breeds = P.List_List$from(t2, true, H.getRuntimeTypeArgument(t2, "Iterable", 0));
      C.JSArray_methods.sort$1(breeds, new D.main_closure());
      for (t1 = breeds.length, t2 = P.int, t5 = [t2], _i = 0, t6 = '    <thead>\n    <tr>\n      <td colspan="2">Breed</td>\n      <td>Depth</td>\n      <td>Health</td>\n      <td>Meander</td>\n      <td>Speed</td>\n      <td>Dodge</td>\n      <td>Exp</td>\n      <td>Count</td>\n      <td>Attacks</td>\n      <td>Moves</td>\n      <td>Tags</td>\n      <td>Flags</td>\n      <td width="20%">Drops</td>\n    </tr>\n    </thead>\n    <tbody>\n    '; _i < breeds.length; breeds.length === t1 || (0, H.throwConcurrentModificationError)(breeds), ++_i, t6 = t8) {
        breed = breeds[_i];
        glyph = breed.get$appearance();
        count = C.JSInt_methods.toString$0(breed.get$countMin());
        t7 = breed.countMax;
        if (t7 !== breed.countMin)
          count += "&thinsp;&ndash;&thinsp;" + t7;
        t7 = glyph.fore;
        t7 = '        <tr>\n          <td>\n            <pre><span style="color: ' + ("rgb(" + t7.r + ", " + t7.g + ", " + t7.b + ")") + '">' + P.String_String$fromCharCodes(H.setRuntimeTypeInfo([glyph.char], t5), 0, null) + "</span></pre>\n          </td>\n          <td>";
        t8 = breed._name;
        t7 = t6 + (t7 + H.S(O.Log__categorize(t8, false, true)) + "</td>\n          <td>" + breed.depth + '</td>\n          <td class="r">' + breed.maxHealth + '</td>\n          <td class="r">' + breed.meander + '</td>\n          <td class="r">' + breed.speed + "</td>\n        ") + ("<td>" + breed.dodge);
        t6 = breed.defenses;
        if (t6.length !== 0) {
          t9 = H.getTypeArgumentByIndex(t6, 0);
          t9 = t7 + ("+" + new H.MappedListIterable(t6, H.functionTypeCheck(new D.main_closure0(), {func: 1, ret: t2, args: [t9]}), [t9, t2]).join$1(0, "+"));
          t6 = t9;
        } else
          t6 = t7;
        t6 = t6 + "</td>" + ('<td class="r">' + breed.get$experience() + "</td>") + ('<td class="r">' + count + "</td>") + "<td>";
        t7 = breed.attacks;
        t9 = H.getTypeArgumentByIndex(t7, 0);
        t9 = t6 + new H.MappedListIterable(t7, H.functionTypeCheck(new D.main_closure1(breed), {func: 1, ret: t3, args: [t9]}), [t9, t3]).join$1(0, "<br>") + "</td>" + ("<td>" + C.JSArray_methods.join$1(breed.moves, "<br>") + "</td>\n");
        t7 = t4.getTags$1(O.Log__categorize(t8, false, true));
        tags = P.List_List$from(t7, true, H.getRuntimeTypeArgument(t7, "Iterable", 0));
        C.JSArray_methods.remove$1(tags, "monster");
        t8 = t9 + ("<td>" + C.JSArray_methods.join$1(tags, ", ") + "</td>") + ("<td>" + breed.flags.toString$0(0) + "</td>") + ('<td><span class="drop" id="' + H.S(O.Log__categorize(t8, false, true)) + '">(drops)</span></td>') + "</tr>";
      }
      t1 = t6 + "</tbody>";
      t2 = document;
      J.setInnerHtml$2$validator$x(C.HtmlDocument_methods.querySelector$1(t2, "table"), t1.charCodeAt(0) == 0 ? t1 : t1, $.$get$validator());
      for (t1 = W.Element, H.assertIsSubtype(t1, t1, "The type argument '", "' is not a subtype of the type variable bound '", "' of type variable 'T' in 'querySelectorAll'."), t2 = new W._FrozenElementList(C.HtmlDocument_methods._querySelectorAll$1(t2, "span.drop"), [t1]), t1 = new H.ListIterator(t2, t2.get$length(t2), 0, [t1]); t1.moveNext$0();) {
        t2 = t1._current;
    ...
    moreDrops: function(span) {
      var breed, drops, t1, t2, i, t3;
      breed = $.$get$Monsters_breeds().find$1(0, span.id);
      drops = $.$get$breedDrops().putIfAbsent$2(breed, new D.moreDrops_closure());
      for (t1 = breed.drop, t2 = breed.depth, i = 0; i < 100; ++i)
        t1.spawnDrop$2(t2, new D.moreDrops_closure0(drops));
...
;
  ...
  (function(lazies) {
    ...
    return t1;
  }, "validator", "breedDrops", "$get$breedDrops", function() {
    return P.LinkedHashMap_LinkedHashMap$_empty(B.Breed, [T.Histogram, P.String]);
  }, "breedDrops"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: S.TeleportAction}, {func: 1, args: [,]}, {func: 1, ret: E.HasteAction}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: G.BurnActorAction, args: [P.int]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, args: [P.String]}, {func: 1, args: [, P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: G.WindAction, args: [P.int]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: G.BurnFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.FreezeActorAction, args: [P.int]}, {func: 1, ret: G.FreezeFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.PoisonAction, args: [P.int]}, {func: 1, ret: G.PoisonFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: E.BlindAction, args: [P.int]}, {func: 1, ret: E.DazzleAction, args: [P.int]}, {func: 1, ret: G.LightFloorAction, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: X.EatAction}, {func: 1, ret: T.DetectAction}, {func: 1, ret: E.ResistAction}, {func: 1, ret: Q.MappingAction}, {func: 1, ret: O.HealAction}, {func: 1, ret: G.RingSelfAction}, {func: 1, ret: G.RingFromAction, args: [L.Vec]}, {func: 1, ret: M.Skill, args: [P.String]}, {func: 1, ret: N.FlowFromAction, args: [L.Vec]}, {func: 1, ret: F.IlluminateSelfAction}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.String, args: [,]}, {func: 1, ret: P.Null, args: [P.int]}, {func: 1, ret: P.Null, args: [L.Vec, U.Hit, P.num, P.int]}, {func: 1, ret: P.int}, {func: 1, ret: P.int, args: [B.Breed, B.Breed]}, {func: 1, ret: P.int, args: [U.Defense]}, {func: 1, ret: P.String, args: [U.Attack]}, {func: 1, ret: P.Null, args: [W.MouseEvent]}, {func: 1, ret: [T.Histogram, P.String]}, {func: 1, ret: P.Null, args: [R.Item]}, {func: 1, ret: P.int, args: [,,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, args: [W.Event]}, {func: 1, ret: N.FlowSelfAction}];
