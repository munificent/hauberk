...
"^":"",
Ly:function(){for(var z=new H.a7([E.Vd(),E.EW(),E.ql(),E.DE(),E.oV(),E.xp(),E.bx(),E.LN(),E.ME(),E.SX(),E.bq(),E.ML(),E.Xm(),E.qq(),E.qZ(),E.Hn(),E.IX(),E.XV(),E.HF(),E.LB(),E.Xs(),E.zz(),E.ab(),E.NH(),E.pN(),E.Hg(),E.pU(),E.B2(),E.Cb(),E.Zb(),E.dX(),E.J1(),E.F3(),E.ji(),E.aD(),E.hf()],36,0,null);z.G();)z.Ff.$0()},
...
mW:[function(){E.IU("k","cowardly",4,2,null)
...
E.N1("Feng",M.mI(),60,[new Y.Xq(null,"stab[s]",0,5,0,1,C.AJ,0,0,0),new G.Zk(6,5),new G.Zk(30,50),new G.hx(5),new G.YQ(new Y.Xq(new Y.Xh("the lightning"),"shocks",0,12,0,1,C.tt,0,0,0),8)],new G.QC(20,G.cq("magic",4)),"cowardly",3,1,null)},"$0","XV",0,0,11],
...
static:{"^":"FQ,ue,kD,tD,Db,qp,rm,Yd,CV,I5,SM,lX,hz",F2:function(a){switch(a){case"none":return C.AJ
...
"^":"",
Xq:{
"^":"a;mq,oq,KH,xV,pG,Aw,FL,zb,c5,cc",
